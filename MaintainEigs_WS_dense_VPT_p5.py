# -*- coding: utf-8 -*-
"""
Created on Thu Feb  5 16:49:06 2026
...
reservoir_type = 'watts_strogatz'
non_normal_type = 'sparse'
maintain_res_eigs = True
ws_p = 0.5
trials = 100
NUMaVals = 51
aVals = np.linspace(0,2,NUMaVals)
...
D['watts_strogatz_p'] = ws_p

np.savez("ConstantEigs"+"_reservoirTest_"+date_str+"_"+reservoir_type+"_non_normal_type_"+non_normal_type+"_watts_strogatz_p_"+str(ws_p)+"_.npz",D)
